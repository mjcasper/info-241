...
```{include} ../info-components/03-learning-checks.md
```
...
<!--
#### 3.1.4. Preparation
```{include} ../info-components/03-preparation.md
```
-->
...
<!--
```{include} ../info-components/03-participation.md
```


#### 3.2.1. In-Class Assignments

```{include} ../info-components/03-participation-assignments.md
```


#### 3.2.2. Peer Evaluation

```{include} ../info-components/03-peer-evaluation.md
```
-->
...
```{include} ../info-components/05-attendance-policy-rider.md
:start-after: rider
```
-->
...
```{include} ../info-components/05-exception-policy.md
```
